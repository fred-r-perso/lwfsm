...
extern volatile uint32_t gButtonCnt;
...
#define STATUS_LED_GPIO_Port GPIOH
#define OCTOSPI_R_IO4_Pin GPIO_PIN_2
#define OCTOSPI_R_IO4_GPIO_Port GPIOH
#define STDIN_Pin GPIO_PIN_10
#define STDIN_GPIO_Port GPIOA
...
#define STDOUT_Pin GPIO_PIN_9
#define STDOUT_GPIO_Port GPIOA
